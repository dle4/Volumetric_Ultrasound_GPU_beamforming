...
Visual comparison plots generated by `run_comparison.py` for a single volume's center slices are shown below:

**Center X-slice Comparison**
![Center X-slice Comparison](example_outputs/comparison_center_x_slice.png)

**Center Y-slice Comparison**
![Center Y-slice Comparison](example_outputs/comparison_center_y_slice.png)

**Center Z-slice Comparison**
![Center Z-slice Comparison](example_outputs/comparison_center_z_slice.png)
